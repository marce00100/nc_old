...
class CrawlController extends Controller
{
    ...
    {
        $procesandoWork = ParametrosController::obtenerValorDeParametro('ConfiguracionCrawl', 'work');
        $tiempoMinutos  = ParametrosController::obtenerValorDeParametro('ConfiguracionCrawl', 'time_m');
        $fuentes        = $this->fuentesValidas();
        $res            = array();
        $cont = 1;
        $mastercont = 1;
        while ($procesandoWork == 1)
        {
            ...
            //     array_push($res, $value);
                sleep(1);
                $procesandoWork = ParametrosController::obtenerValorDeParametro('ConfiguracionCrawl', 'work');
                if ($procesandoWork == 0 || $procesandoWork == '0' )
                {
                    return "la puta " . $cont;
                }
                $cont++;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {
        return collect(\DB::select("SELECT id, fuente_nombre, fuente_url, prioridad, modificado_en
                                        FROM fuentes WHERE permite_rastrear ORDER BY prioridad, fuente_nombre "));
    }
    /*
